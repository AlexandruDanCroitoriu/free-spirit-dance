...
export default function AdministratorsPage() {
  ...
  function openProfile(administrator: Administrator) {
    setEditingProfile(administrator); setProfileName(administrator.name); setProfileImage(null); setProfilePreview(null); setError("");
  }
  ...
  async function saveProfile(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setEditingProfile(null); setProfileImage(null); setProfilePreview(null); setNotice(`Profile saved for ${profile.name}.`);
