...
export type ClassRoster = { cancelled: boolean; canManageClass: boolean; canEdit: boolean; courseName: string; endTime: string | null; rentCostMinor: number; rentPaid: boolean; students: ClassStudent[] };
