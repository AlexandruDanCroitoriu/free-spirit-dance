...
export type ClassRoster = { cancelled: boolean; canManageClass: boolean; canEdit: boolean; canRemoveClass: boolean; courseName: string; endTime: string | null; rentCostMinor: number; rentPaid: boolean; courses: { id: number; name: string }[]; students: ClassStudent[] };
