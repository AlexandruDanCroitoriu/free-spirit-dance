import { deleteTask, duplicateTask, getTasks, taskHandler, updateTask } from '../../../lib/tasks-server';
...
export async function POST(request: Request, context: Context) { return taskHandler(async () => duplicateTask(request, (await context.params).key)); }
