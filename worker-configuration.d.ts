/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./worker-configuration.d.ts` (hash: c85fc20f8c39be48855abf404ec3ecd1)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 nodejs_als
interface __BaseEnv_CloudflareEnv {
	BACKUP_BUCKET: R2Bucket;
	STUDENT_IMAGES: R2Bucket;
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	PUBLIC_QR_BASE_URL: "https://go.alexandru-croitoriu.dev";
	BACKUP_ACCOUNT_ID: "464b96dc41a8bb50dc0ec48941a172e5";
	BACKUP_PRODUCTION_DATABASE_ID: "6de090fa-ec37-493a-9818-a142f35552ae";
	CLOUDFLARE_ACCESS_CLIENT_ID: string;
	CLOUDFLARE_ACCESS_CLIENT_SECRET: string;
	PRODUCTION_BACKUPS: DurableObjectNamespace<import("./worker").ProductionBackupCoordinator>;
	LOCAL_BACKUPS: DurableObjectNamespace<import("./worker").LocalBackupCoordinator>;
	BACKUP_WORKFLOW: Workflow<Parameters<import("./worker").ProductionBackupWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "ProductionBackupCoordinator" | "LocalBackupCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_QR_BASE_URL" | "BACKUP_ACCOUNT_ID" | "BACKUP_PRODUCTION_DATABASE_ID" | "CLOUDFLARE_ACCESS_CLIENT_ID" | "CLOUDFLARE_ACCESS_CLIENT_SECRET">> {}
}
