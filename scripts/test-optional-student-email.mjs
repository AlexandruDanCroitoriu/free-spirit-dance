...
const req=(email)=>new Request('https://school.test/api/students',{method:'POST',headers:{'Content-Type':'application/json','cf-access-authenticated-user-email':'admin@school.test'},body:JSON.stringify({firstName:'Test',lastName:'Student',email,phone:'',birthDate:null,facebookUrl:'',instagramUrl:'',picture:null,active:true})});
