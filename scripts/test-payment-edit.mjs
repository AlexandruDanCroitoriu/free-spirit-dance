...
sqlite.exec("INSERT INTO admin_profiles (email, name) VALUES ('admin@test', ''), ('croitoriu.alexandru.code@gmail.com', ''); INSERT INTO administrator_payment_methods (email, method) VALUES ('admin@test', 'Cash'), ('croitoriu.alexandru.code@gmail.com', 'Cash')");
